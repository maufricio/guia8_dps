...
export default function DetailsScreen( { navigation } ) {
    ...
    const [projects, setProjects] = useState([
        ...
        { id: '2', name: 'Proyecto 2', manager: 'Ana López', contact: 'maria@example.com', socialMedia: ['instagram', 'linkedin']},
        { id: '3', name: 'Proyecto 3', manager: 'carlos Matínez', contact: 'carlos@example.com', socialMedia: ['x',  'linkedin']},
        //Añadir más proyectos según sea necesario
    ]);

    //Funcion para renderizar un elemento de la lista de proyectos
